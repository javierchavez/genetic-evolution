...
{
  public static final float MIN_BLOCK_DIM = 2f; // minimum size in any x, y, or z direction

  public static final float MAX_BLOCK_DIM = 4f; // maximum size in any x, y, or z direction

  public static final int MAX_GENERATION_ATTEMPTS = 22; // maximum number of attempts to try and generate a child block
  ...
  public static final float RECURSE_CHANCE = 0.20f; // chance that a block will spawn at depth n+1 from root block
