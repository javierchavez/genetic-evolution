...
public class GeneticAlgorithm
{
  ...
  private void printFitnessStats(ArrayList<Being> beings)
  {
  ...
  private ArrayList<Being> selection(ArrayList<Being> population)
  {
  ...
  private ArrayList<Being> createNextGeneration(ArrayList<Being> population)
  {
    ...
    ArrayList<Being> newParents = selection(population); //use selection3 method for tournament size 3 instead of 2
    Random rnd = new Random();
    Being parent1;
    Being parent2;
